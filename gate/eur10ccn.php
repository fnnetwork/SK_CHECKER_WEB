...
$sk = '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';
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CCN CHARGED ✅ CHECKED BY @FNxOwner <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
